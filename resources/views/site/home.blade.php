...
<script src="{{URL::asset('/public/js/jquery.sticky.js')}}"></script>

<!-- jQuery easing -->
<script src="{{URL::asset('/public/js/jquery.easing.1.3.min.js')}}"></script>

<!-- Main Script -->
<script src="{{URL::asset('/public/js/js/main.js')}}"></script>
</body>
</html>